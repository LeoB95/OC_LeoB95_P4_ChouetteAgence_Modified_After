  ...
  var createdElements = [],
    defaults = {
              ...
              if (
                ...
                if (
                  ...
                  void 0 !== $this.attr("max") ||
                    void 0 !== $this.attr("aria-valuemax"))
                ) {
                  var max =
                    void 0 !== $this.attr("max")
                      ? $this.attr("max")
                ...
                if (
                  void 0 !== $this.attr("min") ||
                  void 0 !== $this.attr("aria-valuemin")
                ) {
                  var min =
                    void 0 !== $this.attr("min")
                      ? $this.attr("min")
                ...
                void 0 !== $this.attr("maxlength") &&
                  ...
                  (void 0 === $this.attr("required") &&
                    void 0 === $this.attr("aria-required")) ||
                ...
                if (
                  ...
                  $.each(
                    ...
                    function (validatorType, validatorTemplate) {
                      void 0 === validators[validatorType] &&
                  ...
                  "shortcut" === validatorType
                    ...
                    : $.each(
                        ...
                        function (validatorTemplateType, validatorTemplate) {
                          void 0 === validators[validatorTemplateType] &&
                    ...
                    $controlGroup
                      ...
                      (errorsFound = $.unique(errorsFound.sort())).length
                        ...
                        : ($controlGroup.removeClass("warning error success"),
                          value.length > 0 && $controlGroup.addClass("success"),
                          $helpBlock.html(
                            $helpBlock.data("original-contents")
                          )),
      ...
      validatorTypes: {
        ...
        ajax: {
          ...
          validate: function ($this, value, validator) {
            return "" + validator.lastValue == "" + value &&
        ...
        required: {
          ...
          validate: function ($this, value, validator) {
            return (
              !(0 !== value.length || validator.negative) ||
        ...
        match: {
          ...
          init: function ($this, name) {
            var element = $this
              ...
              .first()
              .find(
                '[name="' + $this.data("validation" + name + "Match") + '"]'
              )
              .first();
            return (
    ...
    getValue = function ($this) {
      var value = $this.val(),
        type = $this.attr("type");
      return (
        "checkbox" === type && (value = $this.is(":checked") ? value : ""),
        "radio" === type &&
          (value =
